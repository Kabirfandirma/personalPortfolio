...
import { FaPaperPlane, FaCheckCircle, FaSpinner, FaEnvelope, FaPhone, FaMapMarkerAlt, FaUser } from 'react-icons/fa';
import emailjs from '@emailjs/browser';
import { ScrollReveal, StaggerContainer, StaggerItem } from '../components/ScrollReveal';
import { InteractiveButton, GlassCard } from '../components/InteractiveElements';
                                ...
                                <StaggerItem>
                                    <GlassCard className="p-4 text-center">
                                        ...
                                        <p className="text-muted mb-0">
                                            Whether it's branding, web design, or print materials, 
