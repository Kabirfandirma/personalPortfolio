...
import { FaQuoteLeft, FaStar, FaRegStar, FaPlus, FaUser } from 'react-icons/fa';
import { motion, AnimatePresence } from 'framer-motion';
import { ScrollReveal, StaggerContainer, StaggerItem } from '../components/ScrollReveal';
import { InteractiveCard, InteractiveButton, GlassCard } from '../components/InteractiveElements';
                                            ...
                                            <GlassCard className="p-4 h-100">
                                                <div className="position-relative">
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <small className="text-primary fw-semibold">{testimonial.company}</small>
                                                    </div>
                                                </div>
                                            </GlassCard>
                                        </InteractiveCard>
